...
import { findIngredientHost } from './system/services/host/findByIngredientHost';
import { findRandomHostService } from './system/services/host/findRandomHost';
...
export default class startup {
    ...
    private _setupHostService() {
        ...
        if (this._config.serverType == serverTypes.AzureFunctions) {
            ...
            this._container.bind<contracts.IFindIngredientHost>(contracts.contractSymbols.IFindIngredientHost)
                .to(findIngredientHost).inSingletonScope();

            this._container.bind<contracts.IFindRandomHostService>(contracts.contractSymbols.IFindRandomHostService)
                .to(findRandomHostService).inSingletonScope();
        }
