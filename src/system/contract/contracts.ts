...
export interface IFindIngredientHost extends IHostService{
   
}

export interface IFindRandomHostService extends IHostService{
...
let contractSymbols = {
    ...
    IFindIngredientHost: Symbol("IFindIngredientHost"),
    IFindRandomHostService: Symbol("IFindRandomHostService")  
}
